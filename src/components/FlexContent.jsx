      ...
      >
        ...
        <div className="flex items-center justify-center max-w-xl relative lg:max-w-none w-full">
          <img
            src={img}
            alt={`img/${heading}`}
            className={`w-auto h-[60vh] object-fill transitions-theme ${
              ifExists
                ? "h-100 lg:h-56 md:h-52 sm:h-44 xsm:h-36 rotate-6 hover:-rotate-[20deg]"
                : "h-100 lg:h-64 md:h-60 sm:h-48 xsm:h-40 rotate-6 hover:-rotate-[-20deg]"
            }`}
          />
        </div>
      </div>
